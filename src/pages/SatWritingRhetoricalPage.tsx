    ...
    const rhetoricalQuestions = [
        {
            ...
            explanation: [
                ...
                "<div class='strategy-step'><span class='step-number'>3</span> <span class='step-instruction'><strong>Test your replacement:</strong> \"The city council ultimately <strong>[allowed/okay'ed]</strong> the construction of the new bridge.\"</span></div>",
